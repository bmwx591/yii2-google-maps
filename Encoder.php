...
class Encoder
{
    ...
    /**
     * Generates all values needed for the encoded Google Maps [\bmwx591\google\maps\overlays\Polyline].
     *
     * @param array $points Multidimensional input array of [\bmwx591\google\maps\Point] elements
     *
