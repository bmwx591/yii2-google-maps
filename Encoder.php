...
class Encoder
{
    ...
    /**
     * Generates all values needed for the encoded Google Maps [\bmx591\google\maps\overlays\Polyline].
     *
     * @param array $points Multidimensional input array of [\bmx591\google\maps\Point] elements
     *
